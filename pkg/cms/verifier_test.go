...
func TestVerifyMultipleSigners(t *testing.T) {
	...
	_, _ = asn1.Unmarshal(sid1Bytes, &sid1Raw)
	...
	_, _ = asn1.Unmarshal(sid2Bytes, &sid2Raw)
...
func TestVerifyGoldenVector(t *testing.T) {
	...
	goldenSignatureHex := ""
...
`
	...
	verifiedChain, err := Verify(goldenSignature, goldenData, VerifyOptions{
		Roots: certPoolWithCert(goldenCert),
	})
	if err != nil {
		t.Fatalf("Failed to verify golden vector signature: %v", err)
	}

	if !bytes.Equal(verifiedChain[0].Raw, goldenCert.Raw) {
		t.Errorf("Verified certificate doesn't match expected certificate")
	}
}

func certPoolWithCert(cert *x509.Certificate) *x509.CertPool {
...
func TestVerifyMalformedCMSComprehensive(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			corruptionFunc: func(sig []byte) []byte {
				var ci contentInfo
				_, _ = asn1.Unmarshal(sig, &ci)
				var sd signedData
				_, _ = asn1.Unmarshal(ci.Content.Bytes, &sd)
